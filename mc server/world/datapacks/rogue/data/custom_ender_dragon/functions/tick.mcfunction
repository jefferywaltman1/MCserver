...
#dragon_phase 3
execute if entity @e[type=minecraft:marker,tag=emaster,scores={dragon_phase=3,dragon_health=..700}] run function custom_ender_dragon:p2t/main
execute if entity @e[type=minecraft:marker,tag=emaster,scores={dragon_phase=3,dragon_health=..700}] run scoreboard players set @e[type=marker,tag=emaster] dragon_phase 4
...
#dragon_phase 5
execute if entity @e[type=minecraft:marker,tag=emaster,scores={dragon_phase=5,dragon_health=..400}] run function custom_ender_dragon:p3t/main
execute if entity @e[type=minecraft:marker,tag=emaster,scores={dragon_phase=5,dragon_health=..400}] run scoreboard players set @e[type=marker,tag=emaster] dragon_phase 6
...
#dragon_phase 12
execute if entity @e[type=minecraft:marker,tag=emaster,scores={dragon_phase=12,dragon_health=..250}] run function custom_ender_dragon:p5/subphase_2

#dragon_phase 13
execute if entity @e[type=minecraft:marker,tag=emaster,scores={dragon_phase=13,dragon_health=..100}] run function custom_ender_dragon:p5/subphase_3
...
#meteor
execute at @e[type=minecraft:armor_stand,nbt={OnGround:1b},tag=Meteor] run summon creeper ~ ~ ~ {Fuse:0,Invulnerable:true,CustomName:' "Ender Dragon" ',ExplosionRadius:6}
...
#split
execute at @e[type=minecraft:armor_stand,nbt={OnGround:1b},tag=split_1] run summon creeper ~ ~ ~ {Fuse:0,Invulnerable:true,CustomName:' "Ender Dragon" ',ExplosionRadius:6}
...
execute at @e[type=minecraft:armor_stand,nbt={OnGround:1b},tag=split_2] run summon creeper ~ ~ ~ {Fuse:0,Invulnerable:true,CustomName:' "Ender Dragon" ',ExplosionRadius:4}
...
execute at @e[type=minecraft:armor_stand,nbt={OnGround:1b},tag=split_3] run summon creeper ~ ~ ~ {Fuse:0,Invulnerable:true,CustomName:' "Ender Dragon" ',ExplosionRadius:2}
