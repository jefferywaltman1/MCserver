...
tellraw @s[scores={toggle_ability_feedback=0}] ["",{"translate":"roguecraft.chat_messages.use_ability","italic":true,"color":"gray"},{"text":" "},{"translate":"roguecraft.class_ability.tank","italic":true,"color":"gray"}]
