...
execute store result storage minecraft:master id int 1 run scoreboard players get @e[type=minecraft:marker,tag=master,limit=1] id
...
tellraw @s ["",{"text":"If you don't already have the resource pack, you can download it","color":"aqua"},{"text":" "},{"text":"here","color":"green","bold":true,"underlined":false,"clickEvent":{"action":"open_url","value":"https://modrinth.com/datapack/rogue-craft/version/LuxoEroi"}}]
title @s subtitle {"translate":"roguecraft.bossbar.welcome_2"}
title @s title {"translate":"roguecraft.bossbar.welcome_1"}
tp @s 0.5 125.00 30.5 180 10
