...
tellraw @s[scores={toggle_ability_feedback=0}] ["",{"translate":"roguecraft.chat_messages.use_ability","italic":true,"color":"red"},{"text":" "},{"translate":"roguecraft.class_ability.healer","italic":true,"color":"red"}]
