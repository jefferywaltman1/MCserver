...
execute if data storage minecraft:master {glowing:1} run effect give @s minecraft:glowing infinite 0 true
...
#glass cannon
$execute if score @s class matches 3 run effect give @s minecraft:strength infinite $(strength) true
