...
execute store success storage minecraft:master end_frame int 1 run fill ~3 ~4 ~3 ~-3 ~-2 ~-3 minecraft:end_portal_frame replace minecraft:end_portal_frame
execute store result storage minecraft:master end_frame_count int 1 run fill ~3 ~4 ~3 ~-3 ~-2 ~-3 minecraft:cyan_stained_glass replace minecraft:end_portal_frame
...
execute unless dimension minecraft:overworld if score @s y matches 300.. run fill ~3 ~4 ~3 ~-3 ~-2 ~-3 air destroy
execute unless dimension minecraft:overworld if score @s y matches ..300 run fill ~3 ~4 ~3 ~-3 0 ~-3 air destroy
